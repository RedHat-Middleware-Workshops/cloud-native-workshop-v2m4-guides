...
----
mvn quarkus:add-extension -Dextensions="messaging-kafka" -f $PROJECT_SOURCE/cloud-native-workshop-v2m4-labs/payment-service
----
...
[source,sh,role="copypaste"]
----
mvn clean package -DskipTests -f $PROJECT_SOURCE/cloud-native-workshop-v2m4-labs/payment-service
----
...
We will watch the Kafka topic via a CLI to confirm the messages are being sent/received in Kafka. Click on the *Terminal* tab in OpenShift (not in VS Code!) then execute the following command:
...
[source,sh,role="copypaste"]
----
mvn quarkus:add-extension -Dextensions="messaging-kafka" -f $PROJECT_SOURCE/cloud-native-workshop-v2m4-labs/cart-service
----
...
[source,sh,role="copypaste"]
----
mvn clean package -DskipTests -DskipTests -f $PROJECT_SOURCE/cloud-native-workshop-v2m4-labs/cart-service && \
...
[source,sh,role="copypaste"]
----
mvn quarkus:add-extension -Dextensions="messaging-kafka" -f $PROJECT_SOURCE/cloud-native-workshop-v2m4-labs/order-service
----
...
[source,sh,role="copypaste"]
----
mvn clean package -DskipTests -f $PROJECT_SOURCE/cloud-native-workshop-v2m4-labs/order-service && \
