...
Next, we will create Kafka _Topic_. Click _Add > From Catalog_ again, type in `topic` in the search box, and click on the *Kafka Topic*:
...
oc annotate dc/payment app.openshift.io/vcs-ref=ocp-4.8 --overwrite
----
