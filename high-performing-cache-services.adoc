...
2020-03-19 00:55:12,887 INFO  [io.quarkus] (main) inventory 1.0-SNAPSHOT (running on Quarkus 1.3.0.Final) started in 3.166s. Listening on: http://0.0.0.0:8080
...
oc label dc/coolstore-ui app.kubernetes.io/part-of=coolstore app.openshift.io/runtime=nodejs && \
