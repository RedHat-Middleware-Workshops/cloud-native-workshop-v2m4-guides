...
[source,sh,role="copypaste"]
----
oc label dc/datagrid-service app.openshift.io/runtime=datagrid --overwrite && \
oc label dc/cart app.openshift.io/runtime=java --overwrite && \
oc label dc/catalog app.openshift.io/runtime=spring --overwrite && \
oc label dc/catalog-database app.openshift.io/runtime=postgresql --overwrite && \
oc label dc/order app.openshift.io/runtime=java --overwrite && \
oc label dc/inventory app.openshift.io/runtime=java --overwrite && \
oc label dc/inventory-database app.openshift.io/runtime=postgresql --overwrite && \
oc label dc/datagrid-service app.openshift.io/runtime=java --overwrite && \
oc label dc/order-database app.openshift.io/runtime=mongodb --overwrite && \
oc label dc/coolstore-ui app.openshift.io/runtime=nodejs --overwrite
----

There, that's better:

image::labels.png[coolstore-ui, 800]
