...
----
mvn quarkus:dev -Dquarkus.http.host=0.0.0.0 -f $PROJECT_SOURCE/cloud-native-workshop-v2m4-labs/inventory-service
----
...
Open a *new* VS Code Terminal and invoke the RESTful endpoint using the following CURL command:
...
[source,sh,role="copypaste"]
----
mvn quarkus:add-extension -Dextensions="jdbc-postgresql" -f $PROJECT_SOURCE/cloud-native-workshop-v2m4-labs/inventory-service
----
...
mvn clean compile package -DskipTests -f $PROJECT_SOURCE/cloud-native-workshop-v2m4-labs/inventory-service
----
...
[source,sh,role="copypaste"]
----
mvn clean package spring-boot:repackage -DskipTests -f $PROJECT_SOURCE/cloud-native-workshop-v2m4-labs/catalog-service
----
...
----
oc new-build registry.access.redhat.com/ubi8/openjdk-17:latest --binary --name=catalog -l app=catalog
----
...
[source,sh,role="copypaste"]
----
oc start-build catalog --from-file=$PROJECT_SOURCE/cloud-native-workshop-v2m4-labs/catalog-service/target/catalog-1.0.0-SNAPSHOT.jar --follow
----
...
[source,sh,role="copypaste"]
----
mvn quarkus:add-extension -Dextensions="openshift" -f $PROJECT_SOURCE/cloud-native-workshop-v2m4-labs/cart-service
----
...
[source,sh,role="copypaste"]
----
mvn clean package -DskipTests -f $PROJECT_SOURCE/cloud-native-workshop-v2m4-labs/cart-service
----
...
[source,sh,role="copypaste"]
----
mvn quarkus:add-extension -Dextensions="mongodb-panache,resteasy-reactive-jackson" -f $PROJECT_SOURCE/cloud-native-workshop-v2m4-labs/order-service
----
...
[source,sh,role="copypaste"]
----
cd $PROJECT_SOURCE/cloud-native-workshop-v2m4-labs/coolstore-ui && npm install --save-dev nodeshift
----
