...
INFO  [io.quarkus] (main) inventory 1.0-SNAPSHOT (running on Quarkus xx.xx.xx) started in 3.166s. Listening on: http://0.0.0.0:8080
INFO  [io.quarkus] (main) Profile dev activated. Live Coding activated.
INFO  [io.quarkus] (main) Installed features: [agroal, cdi, hibernate-orm, hibernate-orm-panache, jdbc-h2, narayana-jta, resteasy, resteasy-jsonb, smallrye-health]
----
...
You should see a bunch of log output and CodeReady popup windows that show the endpoints for your local application. Close the popup window for debug port `5005` and accept the popup for `8080`
...
oc annotate dc/catalog app.openshift.io/vcs-ref=ocp-4.8 --overwrite
----
...
oc annotate dc/cart app.openshift.io/vcs-ref=ocp-4.8 --overwrite
----
...
[source,console]
----
[INFO] [SUCCESS] ✅  Extension io.quarkus:quarkus-resteasy-jsonb has been installed
[INFO] [SUCCESS] ✅  Extension io.quarkus:quarkus-mongodb-client has been installed
----
...
[source,sh,role="copypaste"]
----
oc new-app -n {{ USER_ID }}-cloudnativeapps  --as-deployment-config --docker-image mongo:4.0 --name=order-database
----
...
oc annotate dc/order app.openshift.io/vcs-ref=ocp-4.8 --overwrite
----
...
oc annotate dc/coolstore-ui app.openshift.io/vcs-ref=ocp-4.8 --overwrite
----
