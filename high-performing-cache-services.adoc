...
[source,sh,role="copypaste"]
----
mvn clean package spring-boot:repackage -DskipTests -f $PROJECT_SOURCE/catalog-service
----
...
[source,sh,role="copypaste"]
----
oc start-build catalog --from-file=$PROJECT_SOURCE/catalog-service/target/catalog-1.0.0-SNAPSHOT.jar --follow
----
