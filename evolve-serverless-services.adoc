...
2020-04-06 13:48:33,523 INFO  [io.quarkus] (main) getting-started 1.0-SNAPSHOT (powered by Quarkus 1.3.1.Final) started in 0.022s. Listening on: http://0.0.0.0:8080
...
----
    PID   RSS COMMAND
   2828 49716 /tmp/hello/getting-started/target/getting-started-1.0-SNAPSHOT-runner
----
