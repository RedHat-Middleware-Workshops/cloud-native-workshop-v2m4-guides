...
own OpenShift cluster, follow https://access.redhat.com/documentation/en-us/openshift_container_platform/4.13/html/serverless/install#install-serverless-operator[Installing OpenShift Serverless^].
...
buildah-1-10-0              Buildah task builds...   1 week ago
----
