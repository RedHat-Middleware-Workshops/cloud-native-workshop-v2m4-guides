...
That’s _17 milliseconds_ to start up.
...
[source,sh,role="copypaste"]
----
oc start-build payment --from-file --from-file=$CHE_PROJECTS_ROOT/cloud-native-workshop-v2m4-labs/payment-service/target/*-runner --follow
----
