...
2021-02-25 23:30:36,128 INFO  [io.quarkus] (main) getting-started 1.0-SNAPSHOT native (powered by Quarkus 1.7.6.Final-redhat-00014) started in 0.016s. Listening on: http://0.0.0.0:8080
2021-02-25 23:30:36,128 INFO  [io.quarkus] (main) Profile prod activated. 
2021-02-25 23:30:36,128 INFO  [io.quarkus] (main) Installed features: [cdi, resteasy]
----
...
----
    PID   RSS COMMAND
   2682 49260 /tmp/hello/getting-started/target/getting-started-1.0-SNAPSHOT-runner
----

This shows that our process is taking around 49MB of memory (https://en.wikipedia.org/wiki/Resident_set_size[Resident Set
...
quarkus.kubernetes.deploy=true
quarkus.native.native-image-xmx=2g// <3>
quarkus.openshift.expose=true
----
...
[source,sh,role="copypaste"]
----
mvn clean package -Pnative -DskipTests -Dquarkus.package.uber-jar=false -f $CHE_PROJECTS_ROOT/cloud-native-workshop-v2m4-labs/payment-service
----
...
buildah-pr-v0-16-3         Buildah task builds...   5 hours ago
buildah-v0-16-3            Buildah task builds...   5 hours ago
----
