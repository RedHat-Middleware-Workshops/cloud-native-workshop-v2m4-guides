...
mvn io.quarkus:quarkus-maven-plugin:2.2.3.Final-redhat-00013:create \
...
INFO  [io.quarkus] (main) getting-started 1.0.0-SNAPSHOT native (powered by Quarkus 2.5.2.Final) started in 0.023s. Listening on: http://0.0.0.0:8080
...
own OpenShift cluster, follow https://access.redhat.com/documentation/en-us/openshift_container_platform/4.9/html/serverless/install#install-serverless-operator[Installing OpenShift Serverless^].
