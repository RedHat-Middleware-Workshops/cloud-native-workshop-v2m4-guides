...
We will need to create two pre-defined Tekton Tasks that we'll use in our pipeline that know how to compile Java apps and deploy them. Install the `openshift-client` and `s2i-java` Tekton tasks using the following command:
