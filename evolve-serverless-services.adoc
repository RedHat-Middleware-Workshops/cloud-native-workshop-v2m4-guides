...
[source,sh,role="copypaste"]
----
mvn clean package -Pnative -DskipTests -f $PROJECT_SOURCE/cloud-native-workshop-v2m4-labs/payment-service
----
...
oc create -f $PROJECT_SOURCE/cloud-native-workshop-v2m4-labs/payment-service/knative/pipeline/apply_manifests_task.yaml && oc create -f $PROJECT_SOURCE/cloud-native-workshop-v2m4-labs/payment-service/knative/pipeline/update_deployment_task.yaml
----
...
[source,sh,role="copypaste"]
----
oc create -f $PROJECT_SOURCE/cloud-native-workshop-v2m4-labs/payment-service/knative/pipeline/persistent_volume_claim.yaml
----
