...
----
....
[3/7] Building universe...                                                                              (11.6s @ 1.16GB)
[4/7] Parsing methods...      [***]                                                                     (11.6s @ 1.01GB)
[5/7] Inlining methods...     [***]                                                                      (5.1s @ 0.97GB)
[6/7] Compiling methods...    [*********]                                                               (84.5s @ 1.86GB)
[7/7] Creating image...                                                                                  (6.3s @ 2.02GB)
  18.82MB (46.30%) for code area:    32,084 compilation units
  21.51MB (52.92%) for image heap:  274,586 objects and 8 resources
 327.25KB ( 0.79%) for other data
  40.65MB in total
------------------------------------------------------------------------------------------------------------------------
Top 10 packages in code area:                               Top 10 object types in image heap:
   1.62MB sun.security.ssl                                     4.17MB byte[] for code metadata
 964.60KB java.util                                            2.50MB java.lang.String
 733.10KB java.lang.invoke                                     2.40MB java.lang.Class
 717.65KB com.sun.crypto.provider                              2.32MB byte[] for general heap data
 450.53KB sun.security.x509                                    1.92MB byte[] for java.lang.String
 447.23KB java.lang                                          874.33KB com.oracle.svm.core.hub.DynamicHubCompanion
 394.95KB io.netty.buffer                                    731.72KB java.util.HashMap$Node
 381.77KB java.io                                            538.02KB byte[] for reflection metadata
 381.18KB java.util.concurrent                               498.58KB java.lang.String[]
 342.79KB io.netty.handler.codec.http2                       390.79KB byte[] for embedded resources
  12.26MB for 377 more packages                                4.30MB for 2492 more object types
------------------------------------------------------------------------------------------------------------------------
                        9.8s (4.3% of total time) in 44 GCs | Peak RSS: 3.35GB | CPU load: 2.40
------------------------------------------------------------------------------------------------------------------------
Produced artifacts:
...
========================================================================================================================
Finished generating 'getting-started-1.0.0-SNAPSHOT-runner' in 3m 49s.
[INFO] [io.quarkus.deployment.pkg.steps.NativeImageBuildRunner] objcopy --strip-debug getting-started-1.0.0-SNAPSHOT-runner
[INFO] [io.quarkus.deployment.QuarkusAugmentor] Quarkus augmentation completed in 235612ms
[INFO] ------------------------------------------------------------------------
[INFO] BUILD SUCCESS
[INFO] ------------------------------------------------------------------------
[INFO] Total time:  04:00 min
[INFO] Finished at: 2023-06-08T01:13:49Z
[INFO] ------------------------------------------------------------------------
hello $ 
----
...
ELF Header:
  ...
  Start of section headers:          42481592 (bytes into file)
  Flags:                             0x0
...
INFO  [io.quarkus] (main) getting-started 1.0.0-SNAPSHOT native (powered by Quarkus 2.13.7.Final-redhat-00003) started in 0.022s. Listening on: http://0.0.0.0:8080
INFO  [io.quarkus] (main) Profile prod activated. 
INFO  [io.quarkus] (main) Installed features: [cdi, resteasy-reactive, smallrye-context-propagation, vertx]
----

That’s *22 milliseconds* to start up. The start-up time might be different in your environment.
...
----
    PID   RSS COMMAND
   7400 40696 /tmp/hello/getting-started/target/getting-started-1.0.0-SNAPSHOT-runner
----

This shows that our process is taking around *40MB* of memory (https://en.wikipedia.org/wiki/Resident_set_size[Resident Set Size^], or RSS). Pretty compact!
